              ...
              <div class="card-body table-responsive">
							<table id="export" class="table table-bordered table-striped">
								...
								if ($_SESSION['level']=='Pengguna') {
									$siswa = $config->tampil_siswa12($id_sekolah);
								}else{
                	...
                	$tanggal_lahir = new DateTime($data['tanggal_lahir']);
								...
								?>
									...
									<tr>
										...
										<td>
											<a href="hapussiswa-<?php echo $data['id_siswa']; ?>" class="active" onclick="return confirm('Anda ingin menghapus data?')"><i class="fa fa-times text-danger text-active" title="HAPUS"></i></a>
										</td>
									</tr>
