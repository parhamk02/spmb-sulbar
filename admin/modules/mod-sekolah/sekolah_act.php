...
if(isset($_GET['act'])){
	...
	if($act=="create"){
		...
		echo "<script>alert('Data Berhasil Disimpan'); window.location = 'data-sekolah'</script>";
	}
	elseif ($act=="update") {
		...
		echo "<script>alert('Data Berhasil Diupdate'); window.location = 'data-sekolah'</script>";
	...
	elseif ($act=="delete") {
		...
		echo "<script>alert('Data Berhasil Dihapus'); window.location = 'data-sekolah'</script>";
	}
