            ...
            <table class="table table-bordered" style="margin-left: auto; margin-right: auto;" width="100%">
                ...
                <tbody>
                    <tr> 
                        ...
                        <td rowspan="5" width="30%" align="center" valign="middle"><img style="margin-left:0 auto; margin-right:0 auto;" width="130px" src="file/foto/<?php echo $dk['foto'] ?>"></td>
                    </tr>
                    <tr> 
                        <td>Jalur</td>
                        <td align="left"><?php echo $row1['jalurppdb'] ?></td>
                    </tr>
                    <tr> 
                        <td>Jenjang</td>
                        <td align="left"><?php echo $row1['jenjang'] ?></td>
                    </tr>
                    <tr> 
                        <td>Waktu Pendaftaran</td>
                        <td align="left"><?php echo $row1['created_at'] ?></td>
                    </tr>
                    <tr> 
                        <td>Status Pendaftaran</td>
                        <td align="left" style="word-wrap: break-word;"><?php echo $row1['status'] ;if ($row1['status']=='Diterima') {
                ...
                <tbody>
                    <tr> 
                        ...
                        <td align="left" colspan="2">
                            <?php
                                echo $row1['sekolah1']; 
                            if (isset($row1['ket']) and $row1['status1']=="Tidak Diterima") {
                                echo " (".$row1['status1']." karena ".$row1['ket'].")";
                            }
                            ?>
                        </td>
                    </tr>
                    ...
                    <tr> 
                        ...
                        <td align="left" colspan="2">
                            <?php
                                echo $row1['sekolah2']; 
                            if (isset($row1['ket2']) and $row1['status2']=="Tidak Diterima") {
                                echo " (".$row1['status2']." karena ".$row1['ket2'].")";
                            }
                            ?>
                        </td>
                    </tr>
                    ...
                    <tr> 
                        ...
                        <td align="left" colspan="2">
                            <?php
                                echo $row1['sekolah3']; 
                            if (isset($row1['ket3']) and $row1['status3']=="Tidak Diterima") {
                                echo " (".$row1['status3']." karena ".$row1['ket3'].")";
                            }
                            ?>
                        </td>
                    </tr>
